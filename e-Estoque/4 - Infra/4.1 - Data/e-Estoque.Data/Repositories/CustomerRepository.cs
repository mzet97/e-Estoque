...
namespace e_Estoque.Data.Repositories
{
    public class CustomerRepository : Repository<Customer>, ICustomerRepository
    {
        ...
        public override async Task<IEnumerable<Customer>> Search(Expression<Func<Customer, bool>> predicate = null, Func<IQueryable<Customer>, IOrderedQueryable<Customer>> orderBy = null, int? pageSize = null, int? pageIndex = null)
        {
            ...
            if (predicate != null)
            {
                query = query.Include("CustomerAddress").Where(predicate);
            }
