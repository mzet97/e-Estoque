...
namespace e_Estoque.Data.Repositories
{
    public class CompanyRepository : Repository<Company>, ICompanyRepository
    {
        ...
        public override async Task<IEnumerable<Company>> Search(Expression<Func<Company, bool>> predicate = null, Func<IQueryable<Company>, IOrderedQueryable<Company>> orderBy = null, int? pageSize = null, int? pageIndex = null)
        {
            ...
            if (predicate != null)
            {
                query = query.Include("CompanyAddress").Where(predicate);
            }
